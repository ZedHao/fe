...
def get_campaign_list()->list:
    ret= model_campaign_list.twitter_campaign_list_high_priority
    return ret
...
if __name__ == '__main__':
    ...
    execute_plan = helper_random.build_execute_plan(account_list,campaign_list,is_random_account=False,is_group_campaign=True)
